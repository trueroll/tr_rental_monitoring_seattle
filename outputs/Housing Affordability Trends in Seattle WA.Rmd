...
The population of Seattle, WA has grown rapidly over the past decade, from 664,000 in 2010 to 743,000 in 2020. Rents have followed, with median [contract rent](https://usa.ipums.org/usa-action/variables/RENT#description_section) rent 25% higher in 2020 than in 2010. 

Households incomes have also increased - median income rose from \$64,000 to \$90,000 over the decade. Increases in population and rents raise legitimate concern over housing affordability in Seattle. The graph below shows these changes in Seattle. Values are indexed to show the relationship in trends rather than levels. 
